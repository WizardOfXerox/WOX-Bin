...
export const pastes = pgTable(
  "pastes",
  {
    ...
    encryptedShare: boolean("encrypted_share").notNull().default(false),
    encryptedPayloadCiphertext: text("encrypted_payload_ciphertext"),
    encryptedPayloadIv: text("encrypted_payload_iv"),
    encryptedManageTokenHash: text("encrypted_manage_token_hash"),
    encryptedLastViewedAt: timestamp("encrypted_last_viewed_at", { mode: "date" }),
