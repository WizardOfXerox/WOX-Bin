export const RATE_LIMIT_CONFIG = {
  ...
  "privacy-create": { max: 24, window: "1 h", windowMs: 60 * 60_000, prefix: "wox:privacy:create" },
  "privacy-vote": { max: 40, window: "1 h", windowMs: 60 * 60_000, prefix: "wox:privacy:vote" },
  "privacy-chat": { max: 80, window: "1 h", windowMs: 60 * 60_000, prefix: "wox:privacy:chat" },
  ...
  "paste-unlock": { max: 10, window: "10 m", windowMs: 10 * 60_000, prefix: "wox:paste:unlock" },
  "workspace-import-url": { max: 30, window: "1 h", windowMs: 60 * 60_000, prefix: "wox:workspace:import" },
  "account-password-change": { max: 5, window: "15 m", windowMs: 15 * 60_000, prefix: "wox:account:pwchange" },
