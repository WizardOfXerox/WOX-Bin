        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_12rem]">
            <div className="space-y-2">
              ...
              <Input id="chat-title" onChange={(event) => setTitle(event.target.value)} placeholder="Release war room" value={title} />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="chat-message" onChange={(event) => setMessage(event.target.value)} placeholder="The build failed on staging. Here's what changed..." value={message} />
          </div>
